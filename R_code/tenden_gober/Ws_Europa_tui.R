...
uber_tweets1 <- search_tweets("tourism", n = 1000000, include_rts = FALSE, lang="en", geocode =  "47.81027,12.98202,2000km",time = "2005-01-01 2019-10-30")#localizacion del centro de salzburg, Austria
uber_tweets2 <- search_tweets("governance", n = 1000000, include_rts = FALSE, lang="en", geocode =  "47.81027,12.98202,2000km", time = "2005-01-01 2019-10-30")
...
write.csv(a, file="tureu.csv")
tw1 <- search_tweets("tourism", n = 1000000, include_rts = TRUE, lang="en", geocode =  "47.81027,12.98202,2000km",time = "2005-01-01 2019-10-30")#localizacion del centro de salzburg, Austria
...
a<-uber_tweets2 %>% 
  ...
  arrange(desc(followers_count)) %>% 
  select(screen_name, followers_count, location, text)
write.csv(a, file="eurgov5.csv")
tw2 <- search_tweets("governance", n = 1000000, include_rts = TRUE, lang="en", geocode =  "47.81027,12.98202,2000km", time = "2005-01-01 2019-10-30")
...
Categoria <- rep("Tourism" , 4551)
uber_tweets11 <- data.frame(uber_tweets1,Categoria)
Categoria <- rep("Governance" , 3494)
...
plot(sentiment_scores)+geom_line(size=0.1)#Aumentar tamaño de la letra
...
plot(sentiment_scores1) +geom_line(size=0.1)#Aumentar tamaño de la letra
...
plot(sentiment_scores2)+geom_line(size=0.1)#Aumentar tamaño de la letra
...
stopwords(kind='en')#en ingles, es español
