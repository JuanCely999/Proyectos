...
uber_tweets1 <- search_tweets("tourism", n = 1000000, include_rts = FALSE, lang="en", geocode =  "-18.98468,32.67164,2000km",time = "2005-01-01 2019-10-30")#localizacion del centro de mutare, Zimbabwe
uber_tweets2 <- search_tweets("governance", n = 1000000, include_rts = FALSE, lang="en", geocode =  "-18.98468,32.67164,2000km", time = "2005-01-01 2019-10-30")
...
Categoria <- rep("Tourism" , 1458)
uber_tweets11 <- data.frame(uber_tweets1,Categoria)
Categoria <- rep("Governance" , 1656)
