...
uber_tweets1 <- search_tweets("tourism", n = 1000000, include_rts = FALSE, lang="en", geocode =  "30.93019,90.32588,2000km",time = "2005-01-01 2019-10-30")#localizacion del centro de tibet, China
uber_tweets2 <- search_tweets("governance", n = 1000000, include_rts = FALSE, lang="en", geocode =  "30.93019,90.32588,2000km", time = "2005-01-01 2019-10-30")
...
Categoria <- rep("Tourism" , 2752)
uber_tweets11 <- data.frame(uber_tweets1,Categoria)
Categoria <- rep("Governance" , 3990)
