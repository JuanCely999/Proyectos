...
setwd("~/Documents/Investigacion/Tendencias mundiales. Gobernanza/WOS/Bibliometria R/2019/")
...
uptc <- readFiles("savedrecs (1).bib","savedrecs (2).bib","savedrecs (3).bib","savedrecs (4).bib"
                  ...
                  ,"savedrecs (9).bib","savedrecs (10).bib")#sumatoria de los documentos recoopilados
