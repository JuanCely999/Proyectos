...
############################################################################
directorio <- "~/Documents/Investigacion/Inclusion Santo Tomas/Bibliometria inclusion/"
setwd(directorio)

uptc <- readFiles("savedrecs.bib","savedrecs (2).bib","savedrecs (3).bib","savedrecs (4).bib"
                  ,"savedrecs (5).bib","savedrecs (6).bib","savedrecs (7).bib","savedrecs (8).bib")#sumatoria de los documentos recoopilados
