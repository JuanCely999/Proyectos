...
################################
acuerdos <- read_lines("DII2.txt", skip = 1, n_max = 218-1 ) #135-1 entrevistas CD,218-1 entrevistas escritas leyendo el documento 135-0.txt desde la linea 1 hasta la linea 135
