...
############################################################################
############################################################################
# New Curve Phillips Neokeynesian
############################################################################
...
net=networkPlot(NetMatrix, n = 20, Title = "Co-Citation Network", type = "auto", size.cex=TRUE, size=15, remove.multiple=FALSE, labelsize=1,edgesize = 5, edges.min=5)
...
# Plot the network
net=networkPlot(NetMatrix, n = 20, Title = "", type = "circle", size=TRUE, edgesize = 10, remove.multiple=FALSE)
...
############################################################################
############################################################################
# Relacion inflation-marginal cost
############################################################################
uptc <- readFiles("savedrecs1.bib")#sumatoria de los documentos recoopilados
...
M=metaTagExtraction(M,"CR_SO",sep=";")
NetMatrix <- biblioNetwork(M, analysis = "co-citation", network = "sources", sep = ";")
net=networkPlot(NetMatrix, n = 20, Title = "", type = "auto", size.cex=TRUE, size=15, remove.multiple=FALSE, labelsize=1,edgesize = 5, edges.min=5)
...
NetMatrix<-biblioNetwork(M, analysis = "collaboration", network = "countries", sep = ";")
# Plot the network
net=networkPlot(NetMatrix, n = 20, Title = "", type = "circle", size=TRUE,remove.multiple=FALSE)
